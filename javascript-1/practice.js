...
//Code here
let lovesCodeChecker = (x) => {return x}
//////////////////PROBLEM 6////////////////////
...
//Code here
let oddChecker = (num) => {return num % 2 === 0 ? 'the number is even' : 'the number is odd'}
//////////////////PROBLEM 7////////////////////
...
// Code Here
let doubled = myNumbers.map(function (el){
	return el * 2
})
...
// Code Here
let filtered = myNumbers.filter(function(el) {
	return el > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce((acc,el,i,arr) =>{
	return acc + el
})
//////////////////PROBLEM 17////////////////////
